...
<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="795.9" height="433" viewBox="0 0 795.9 433">
	<style>
		.white_page			{fill:#fff;}
		.dark_gray_page			{fill:#a9a9a9;}
		.medium_gray			{fill:#ccc;}
		.light_orange			{fill:#fca671;}
		.orange			{fill:#e96019;}
		.top-martini			{fill:#fdd2b8;}
		.dark_navy
			{fill:#1b2c3d;}
		.green			{fill:#a48801;}
		.med-blue			{fill:#395d6d;}
		.light-blue			{fill:#e8eaec;}
		.extra-light-o			{fill:#fce7dc;}
		.extra2-light-o			{fill:#fff2ea;}
		.navy-light			{fill:#495664;}
		.light-green			{fill:#bfac4d;}
		.light-bubbles			{fill:#e1e7e9;}
	</style>
	<g class="page-fall2">
